...
import com.example.exploringviews.BaseViewModel.Companion.instanceCounterC
import com.example.exploringviews.databinding.ActivityCBinding

class ActivityC : BaseActivity<ActivityCBinding, BaseViewModel>() {
    ...
    init {
        instanceCounterC++
        currentInstanceValue = instanceCounterC
    }
